 ...
 */
export const persistedCloudModeSessionsState = new PersistedState<LocalSessionInfo[]>(
	"CodeAgentStorage:cloud-mode-sessions-state",
	[],
);
...
class CloudModeSessionsState {
	...
	sessions = $derived(persistedCloudModeSessionsState.current);
...
export const cloudModeSessionsState = new CloudModeSessionsState();
