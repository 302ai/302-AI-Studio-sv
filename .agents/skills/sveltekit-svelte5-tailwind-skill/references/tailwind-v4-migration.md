...
<div class:bg-blue-500={variant === "primary"} class:bg-green-500={variant === "secondary"}>
...
<div style="--brand: #3B82F6;" class="bg-[--brand]">Better approach</div>
```
...
<!-- ✅ New feature in v4 -->
<div class="@container">
	<div class="@sm:text-lg @md:text-xl @lg:text-2xl">Responsive to container, not viewport</div>
</div>
```
...
<div class="p-8 space-y-4">
	<h1 class="text-4xl font-bold text-blue-600">Tailwind v4 Test Page</h1>
	...
	<!-- Test responsive -->
	<div class="text-sm md:text-base lg:text-lg xl:text-xl">Responsive text sizing</div>

	<!-- Test dark mode -->
	<div class="bg-white dark:bg-gray-800 text-black dark:text-white p-4">Dark mode test</div>
	...
	<div class="text-brand text-glow">Custom utilities test</div>
</div>
```
