...
<div class="relative">
	...
	<div class="mt-48 space-y-2">
		<input type="range" bind:value={width} min="50" max="400" class="w-full" />
		<input type="range" bind:value={height} min="50" max="400" class="w-full" />
		<input type="range" bind:value={rotation} min="0" max="360" class="w-full" />
	</div>
</div>
```
...
<p class={colors.text}>Status description</p>
```
...
<div class:bg-blue-500={color === "blue"} class:bg-red-500={color === "red"}>Good</div>
```
