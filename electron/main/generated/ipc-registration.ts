import { ipcMain } from 'electron';
		import { broadcastService, storageService, generalSettingsService, aiApplicationService, appService, dataService, externalLinkService, mcpService, tabService, windowService, shortcutService, threadService, updaterService } from '../services';
...
ipcMain.handle('tabService:handleTabCloseAll', (event) =>
	tabService.handleTabCloseAll(event)
);
