...
export interface AutoGeneratedIpcServices {
	...
	threadService: {
		...
		toggleThreadFavorite(threadId: string): Promise<boolean>;
		addThread(threadId: string): Promise<void>;
		removeThread(threadId: string): Promise<void>;
		isFavorite(threadId: string): Promise<boolean>;
	};
	tabService: {
	...
	windowService: {
		handleSplitShellWindow(triggerTabId: string): Promise<void>;
...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	threadService: {
		...
		toggleThreadFavorite: (threadId: string) =>
			ipcRenderer.invoke("threadService:toggleThreadFavorite", threadId),
		addThread: (threadId: string) => ipcRenderer.invoke("threadService:addThread", threadId),
		removeThread: (threadId: string) => ipcRenderer.invoke("threadService:removeThread", threadId),
		isFavorite: (threadId: string) => ipcRenderer.invoke("threadService:isFavorite", threadId),
	},
	tabService: {
