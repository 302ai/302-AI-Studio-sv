/* eslint-disable @typescript-eslint/no-explicit-any */
		...
		import type { BroadcastEvent, StorageValue, StorageOptions, StorageMetadata, StorageMeta, StorageItem, Theme, ImportResult, McpServer, TabType, Tab, ShortcutBinding, ShortcutConflict, ShortcutSyncEvent, ThreadData } from '@shared/types';
...
handle302AIProviderChange(): Promise<void>;
};
appService: {
...
handleNewTab(title: string, type: TabType, active: boolean, href?: string): Promise<string | null>;
...
generalSettingsService: {
handleLanguageChanged: () => ipcRenderer.invoke('generalSettingsService:handleLanguageChanged'),
},
aiApplicationService: {
getAiApplicationUrl: (applicationId: number) => ipcRenderer.invoke('aiApplicationService:getAiApplicationUrl', applicationId),
handle302AIProviderChange: () => ipcRenderer.invoke('aiApplicationService:handle302AIProviderChange'),
},
appService: {
...
handleNewTab: (title: string, type: TabType, active: boolean, href?: string) => ipcRenderer.invoke('tabService:handleNewTab', title, type, active, href),
...
handleMoveTabIntoExistingWindow: (triggerTabId: string, windowId: string) => ipcRenderer.invoke('windowService:handleMoveTabIntoExistingWindow', triggerTabId, windowId),
},
shortcutService: {
