...
export interface AutoGeneratedIpcServices {
	...
	windowService: {
		handleOpenSettingsWindow(): Promise<void>;
...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	aiApplicationService: {
		...
		handle302AIProviderChange: () =>
			ipcRenderer.invoke("aiApplicationService:handle302AIProviderChange"),
	},
	appService: {
	...
	windowService: {
		handleOpenSettingsWindow: () => ipcRenderer.invoke("windowService:handleOpenSettingsWindow"),
