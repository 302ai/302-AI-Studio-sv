...
export interface AutoGeneratedIpcServices {
	...
	generalSettingsService: {
		...
		handleProxyChanged(proxySettings: ProxySettings): Promise<void>;
		testProxyConnection(
			proxySettings: ProxySettings,
		): Promise<{ success: boolean; error?: string }>;
		getCacheDirectory(): Promise<string>;
		setCacheDirectory(dirPath: string): Promise<{ success: boolean; error?: string }>;
		getCacheInfo(): Promise<CacheInfo>;
		clearCache(): Promise<void>;
		resetCacheToDefault(): Promise<void>;
		selectCacheDirectory(): Promise<string | null>;
	};
	ssoService: {
		openSsoLogin(
			serverPort: number,
	...
	localVibeService: {
		...
		restartPodmanMachine(): Promise<void>;
		updateOpenclawModels(): Promise<{ success: boolean; error?: string }>;
	};
	codeAgentService: {
	...
	threadStateService: {
		updateBusyState(data: {
			threadId: string;
			isBusy: boolean;
			reason?: string;
		}): Promise<void>;
		getBusyThreads(): Promise<Record<string, { isBusy: boolean; reason?: string }>>;
		getBusyLocalAgentThreads(): Promise<string[]>;
	};
	tabService: {
		handleUpdateTabType(tabId: string, type: TabType): Promise<void>;
	...
	cloudModeService: {
		overrideCloudModeHealthPolling(mode: "fast" | "normal"): Promise<void>;
		syncCloudInstanceToLocalByIpc(): Promise<{
			isOk: boolean;
			data: InstanceInfo[];
			error?: { code: string; message: string };
		}>;
		syncAndStartPollingByIpc(): Promise<{ isOk: boolean }>;
		getCloudModeInstanceBaseUrlByIpc(): Promise<{ isOk: boolean; baseUrl: string }>;
		getHealthStatusByIpc(): Promise<SandboxHealthResponse | null>;
		refreshHealthByIpc(): Promise<SandboxHealthResponse | null>;
	};
	dataService: {
	...
	devLauncherService: {
		...
		stopDevSandbox(): Promise<{ isOk: boolean; error?: string }>;
	};
	externalLinkService: {
		...
		open302WebsiteLink(path: string): Promise<{
			isOk: boolean;
			error?: string;
		}>;
	};
	...
	openClawService: {
		getOpenClawWebUiUrl(): Promise<string | null>;
		applyOpenClawChannelConfig(): Promise<void>;
		applyCloudClawChannelConfig(): Promise<void>;
		applyOpenClawBindingsConfig(threadId: string): Promise<void>;
		applyCloudClawBindingsConfig(threadId: string): Promise<void>;
		restartCloudOpenClaw(instanceName: string): Promise<void>;
		handleOpenClawWebUiReloadIpc(tabId: string): Promise<void>;
		wechatInsalled(): Promise<boolean>;
		connectWechat(): Promise<void>;
		installWechat(): Promise<boolean>;
		disposeWechat(): Promise<void>;
	};
	providerService: {
		handle302AIProviderChange(apiKey: string): Promise<void>;
		get302AIApiKey(): Promise<string>;
		get302AIBaseUrl(): Promise<string>;
		get302AIBaseUrlWithoutV1(): Promise<string>;
		get302WebsiteBaseDomain(): Promise<string>;
		get302WebsiteUrl(path: string): Promise<string>;
	};
	threadService: {
...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	pluginService: {
		...
		enablePlugin: (pluginId: string) =>
			ipcRenderer.invoke("pluginService:enablePlugin", pluginId),
		...
		updatePlugin: (pluginId: string) =>
			ipcRenderer.invoke("pluginService:updatePlugin", pluginId),
		reloadPlugin: (pluginId: string) =>
			ipcRenderer.invoke("pluginService:reloadPlugin", pluginId),
	...
	generalSettingsService: {
		...
		handleProxyChanged: (proxySettings: ProxySettings) =>
			ipcRenderer.invoke("generalSettingsService:handleProxyChanged", proxySettings),
		testProxyConnection: (proxySettings: ProxySettings) =>
			ipcRenderer.invoke("generalSettingsService:testProxyConnection", proxySettings),
		getCacheDirectory: () => ipcRenderer.invoke("generalSettingsService:getCacheDirectory"),
		setCacheDirectory: (dirPath: string) =>
			ipcRenderer.invoke("generalSettingsService:setCacheDirectory", dirPath),
		getCacheInfo: () => ipcRenderer.invoke("generalSettingsService:getCacheInfo"),
		clearCache: () => ipcRenderer.invoke("generalSettingsService:clearCache"),
		resetCacheToDefault: () => ipcRenderer.invoke("generalSettingsService:resetCacheToDefault"),
		selectCacheDirectory: () =>
			ipcRenderer.invoke("generalSettingsService:selectCacheDirectory"),
	},
	ssoService: {
	...
	shortcutService: {
		init: (shortcuts: ShortcutBinding[]) =>
			ipcRenderer.invoke("shortcutService:init", shortcuts),
	...
	localVibeService: {
		...
		restartPodmanMachine: () => ipcRenderer.invoke("localVibeService:restartPodmanMachine"),
		updateOpenclawModels: () => ipcRenderer.invoke("localVibeService:updateOpenclawModels"),
	},
	codeAgentService: {
		...
		updateClaudeCodeSandboxRemark: (sandbox_id: string, remark: string) =>
			ipcRenderer.invoke(
				"codeAgentService:updateClaudeCodeSandboxRemark",
				sandbox_id,
				remark,
			),
		...
		addClaudeCodeSandboxMCP: (
			...
			ipcRenderer.invoke(
				"codeAgentService:addClaudeCodeSandboxMCP",
				sandboxId,
				MCPInfos,
				mode,
			),
		...
		deleteWorkspaceDirectory: (subPath: string) =>
			ipcRenderer.invoke("codeAgentService:deleteWorkspaceDirectory", subPath),
		renameWorkspaceDirectory: (oldSubPath: string, newSubPath: string) =>
			ipcRenderer.invoke("codeAgentService:renameWorkspaceDirectory", oldSubPath, newSubPath),
	},
	windowService: {
	...
	deepLinkService: {
		simulateDeepLink: (url: string) =>
			ipcRenderer.invoke("deepLinkService:simulateDeepLink", url),
	},
	threadStateService: {
		...
		getBusyLocalAgentThreads: () =>
			ipcRenderer.invoke("threadStateService:getBusyLocalAgentThreads"),
	},
	tabService: {
		handleUpdateTabType: (tabId: string, type: TabType) =>
			ipcRenderer.invoke("tabService:handleUpdateTabType", tabId, type),
		handleNewTabWithThread: (
			threadId: string,
			title: string,
			type: TabType,
		...
		handleActivateTab: (tabId: string) =>
			ipcRenderer.invoke("tabService:handleActivateTab", tabId),
		getActiveTab: () => ipcRenderer.invoke("tabService:getActiveTab"),
		getAllTabsForCurrentWindow: () =>
			ipcRenderer.invoke("tabService:getAllTabsForCurrentWindow"),
	...
	aiApplicationService: {
		...
		refreshAiApplications: () =>
			ipcRenderer.invoke("aiApplicationService:refreshAiApplications"),
	},
	appService: {
		...
		createDirectory: (dirPath: string) =>
			ipcRenderer.invoke("appService:createDirectory", dirPath),
		deleteFile: (filePath: string) => ipcRenderer.invoke("appService:deleteFile", filePath),
		deleteDirectory: (dirPath: string) =>
			ipcRenderer.invoke("appService:deleteDirectory", dirPath),
	...
	cloudModeService: {
		overrideCloudModeHealthPolling: (mode: "fast" | "normal") =>
			ipcRenderer.invoke("cloudModeService:overrideCloudModeHealthPolling", mode),
		syncCloudInstanceToLocalByIpc: () =>
			ipcRenderer.invoke("cloudModeService:syncCloudInstanceToLocalByIpc"),
		syncAndStartPollingByIpc: () =>
			ipcRenderer.invoke("cloudModeService:syncAndStartPollingByIpc"),
		getCloudModeInstanceBaseUrlByIpc: () =>
			ipcRenderer.invoke("cloudModeService:getCloudModeInstanceBaseUrlByIpc"),
		getHealthStatusByIpc: () => ipcRenderer.invoke("cloudModeService:getHealthStatusByIpc"),
		refreshHealthByIpc: () => ipcRenderer.invoke("cloudModeService:refreshHealthByIpc"),
	},
	dataService: {
	...
	devLauncherService: {
		launchDevSandbox: (imageAddress: string, engine: string) =>
			ipcRenderer.invoke("devLauncherService:launchDevSandbox", imageAddress, engine),
		stopDevSandbox: () => ipcRenderer.invoke("devLauncherService:stopDevSandbox"),
	},
	externalLinkService: {
		openExternalLink: (url: string) =>
			ipcRenderer.invoke("externalLinkService:openExternalLink", url),
		open302WebsiteLink: (path: string) =>
			ipcRenderer.invoke("externalLinkService:open302WebsiteLink", path),
	},
	loggerService: {
		log: (
			level: LogLevel,
			...
			message: string,
			args: any[],
		) => ipcRenderer.invoke("loggerService:log", level, category, processType, message, args),
		exportLogs: (startDate: string, startHour: number, endDate: string, endHour: number) =>
			ipcRenderer.invoke("loggerService:exportLogs", startDate, startHour, endDate, endHour),
	},
	mcpService: {
	...
	openClawService: {
		getOpenClawWebUiUrl: () => ipcRenderer.invoke("openClawService:getOpenClawWebUiUrl"),
		applyOpenClawChannelConfig: () =>
			ipcRenderer.invoke("openClawService:applyOpenClawChannelConfig"),
		applyCloudClawChannelConfig: () =>
			ipcRenderer.invoke("openClawService:applyCloudClawChannelConfig"),
		applyOpenClawBindingsConfig: (threadId: string) =>
			ipcRenderer.invoke("openClawService:applyOpenClawBindingsConfig", threadId),
		applyCloudClawBindingsConfig: (threadId: string) =>
			ipcRenderer.invoke("openClawService:applyCloudClawBindingsConfig", threadId),
		restartCloudOpenClaw: (instanceName: string) =>
			ipcRenderer.invoke("openClawService:restartCloudOpenClaw", instanceName),
		handleOpenClawWebUiReloadIpc: (tabId: string) =>
			ipcRenderer.invoke("openClawService:handleOpenClawWebUiReloadIpc", tabId),
		wechatInsalled: () => ipcRenderer.invoke("openClawService:wechatInsalled"),
		connectWechat: () => ipcRenderer.invoke("openClawService:connectWechat"),
		installWechat: () => ipcRenderer.invoke("openClawService:installWechat"),
		disposeWechat: () => ipcRenderer.invoke("openClawService:disposeWechat"),
	},
	providerService: {
		...
		get302AIBaseUrl: () => ipcRenderer.invoke("providerService:get302AIBaseUrl"),
		get302AIBaseUrlWithoutV1: () =>
			ipcRenderer.invoke("providerService:get302AIBaseUrlWithoutV1"),
		get302WebsiteBaseDomain: () =>
			ipcRenderer.invoke("providerService:get302WebsiteBaseDomain"),
		get302WebsiteUrl: (path: string) =>
			ipcRenderer.invoke("providerService:get302WebsiteUrl", path),
	},
	threadService: {
		...
		deleteThread: (threadId: string) =>
			ipcRenderer.invoke("threadService:deleteThread", threadId),
		renameThread: (threadId: string, newName: string) =>
			ipcRenderer.invoke("threadService:renameThread", threadId, newName),
		addFavorite: (threadId: string) =>
			ipcRenderer.invoke("threadService:addFavorite", threadId),
...
export interface ElectronAPIExtension {
	...
	cloudModeService: AutoGeneratedIpcServices["cloudModeService"];
	dataService: AutoGeneratedIpcServices["dataService"];
	devLauncherService: AutoGeneratedIpcServices["devLauncherService"];
	externalLinkService: AutoGeneratedIpcServices["externalLinkService"];
	loggerService: AutoGeneratedIpcServices["loggerService"];
	mcpService: AutoGeneratedIpcServices["mcpService"];
	notificationService: AutoGeneratedIpcServices["notificationService"];
	openClawService: AutoGeneratedIpcServices["openClawService"];
