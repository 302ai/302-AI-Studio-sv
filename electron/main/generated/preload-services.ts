...
export interface AutoGeneratedIpcServices {
	...
	cloudModeService: {
		...
		getCloudModeInstanceBaseUrl(): Promise<{ isOk: boolean; baseUrl: string }>;
...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	cloudModeService: {
		...
		getCloudModeInstanceBaseUrl: () =>
			ipcRenderer.invoke("cloudModeService:getCloudModeInstanceBaseUrl"),
