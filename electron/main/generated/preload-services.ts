...
export interface AutoGeneratedIpcServices {
	...
	cloudModeService: {
		...
		registerBroadcasterTimed(): Promise<void>;
		unregisterBroadcasterTimed(): Promise<void>;
	};
	dataService: {
...
export const autoGeneratedServices: AutoGeneratedIpcServices = {
	...
	cloudModeService: {
		...
		registerBroadcasterTimed: () =>
			ipcRenderer.invoke("cloudModeService:registerBroadcasterTimed"),
		unregisterBroadcasterTimed: () =>
			ipcRenderer.invoke("cloudModeService:unregisterBroadcasterTimed"),
	},
	dataService: {
